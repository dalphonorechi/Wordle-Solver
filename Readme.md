...
The biggest on with this wordle solver is that if the HTML elements of worlde is change the code has to be changed also to match that since we read data from these elements.